---
description: Read-only research agent. Investigates a question across the local codebase and returns a synthesized answer to the screen. Never writes, edits, or commits.
mode: all
temperature: 0.4
skills: []
tools:
